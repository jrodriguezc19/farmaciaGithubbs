...
?>
  ...
  <!--     color     -->
<div style="background-color: #ABB6E3" class="page-wrapper">

    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-primary">Editar Medicamento</h3>
        </div>
    ...
    <div>
<h1 style="color:#45B39D; padding:30px; text-align: center;">Editar Medicamento</h1>
</div>
                        ...
                        <div class="input-states">
                            <form action="php_action/editProductImage.php?id=<?php echo $_GET['id']; ?>" method="POST" id="updateProductImageForm" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <img src="assets/myimages/<?php echo $result['product_image'] ?>" style="width:175px; height:170px;">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <label for="editProductImage" class="col-sm-3 control-label">SELECCIONE UNA FOTO DEL MEDICAMENTO: </label>
                                    ...
                                    <div class="col-md-2 mx-auto">
                                        <button type="submit" name="btn" id="changeUsernameBtn" class="btn btn-primary btn-flat m-b-30 m-t-30">Actualizar Medicamento</button>
                                    </div>
                                </fieldset>
                                ...
                                <fieldset>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="Batch No" placeholder="Descripcion" name="bno" autocomplete="off" value="<?php echo $result['bno'] ?>" required="" pattern="^[Aa-Zz]+$" />
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="precioProducto" value="<?php echo $result['rate'] ?>" name="precioProducto" autocomplete="off">
                                        </div>
                                        ...
                                        <div class="col-md-12 mx-auto text-center">
                                            <button href="product.php" style="text-align: center;" type="submit" name="create" id="createCategoriesBtn" class="btn btn-primary btn-flat m-b-30 m-t-30">Cancelar</button>
                                        </div>
