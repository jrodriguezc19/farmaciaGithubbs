        ...
        <div class="popup popup--icon -error js_error-popup popup--visible">
          ...
          <div class="popup__content">
            <h3 class="popup__content__title">
              ...
              <p>DATOS ADMINISTRADOR INCORRECTOS</p>
              <p>
...
<div id="main-wrapper">
  <div class="unix-login">
    ...
    <div class="container-fluid" style="background-image: url('assets/uploadImage/Logo/fondo.jpg');
 ...
 >
      ...
      "
      >
        <div class="col-md-4"style=" font-size:xx-large;   box-sizing: inherit;
    margin-inline: auto;>
          <div class="login-content ">
            <div class="login-form">
              <center><img src="assets/uploadImage/Logo/longs.png" style="width: 300px;"></center><br>
              <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" id="loginForm" class="row">
                <div class="form-group col-md-12">
                  ...
                  <input type="text" name="email" id="email" class="form-control" placeholder="correo" pattern="[^@\s]+@[^@\s]+\.[^@\s]+" title="DIRECCION  NO VALIDA" required="">
...
<footer class="bg-primary text-white text-center text-lg-start fixed-bottom">
  ...
  FARMACIA SAN JUAN, SACATEPEQUEZ, ANTIGUA GUATEMALA
    <a class="text-white" href="FARMACIA SAN JUAN, SACATEPEQUEZ, ANTIGUA GUATEMALA"></a>
  </div>
  <!-- Copyright -->
</footer>
</div>
